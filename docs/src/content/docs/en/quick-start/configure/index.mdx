...
| HBOX_AI_ENABLED                         | false                                                                                          | enable the authenticated AI inventory capture workflow                                                                                                                                    |
| HBOX_AI_PROVIDER_NAME                   | Primary AI                                                                                     | display name for the primary/default vision provider shown during review                                                                                                                   |
| HBOX_AI_BASE_URL                        | https://api.openai.com/v1                                                                      | base URL of an OpenAI-compatible chat-completions API, including `/v1`; LiteLLM and llama.cpp endpoints are supported                                                                      |
| HBOX_AI_API_KEY                         |                                                                                                | provider API key; kept server-side and redacted from configuration output. May be empty for a trusted local provider                                                                      |
| HBOX_AI_MODEL                           | gpt-4.1-mini                                                                                   | vision-capable model name sent to the provider                                                                                                                                             |
| HBOX_AI_REASONING_EFFORT                |                                                                                                | optional OpenAI-compatible reasoning effort. Set to `none` for llama.cpp Qwen deployments that would otherwise spend the completion budget on reasoning                                    |
| HBOX_AI_TIMEOUT                         | 2m                                                                                             | timeout for each vision analysis or correction request                                                                                                                                     |
| HBOX_AI_MAX_PHOTOS                      | 8                                                                                              | maximum photos sent in one provider request; ungrouped photos are batched, while one same-item group cannot exceed this size                                                               |
| HBOX_AI_MAX_SESSION_PHOTOS              | 24                                                                                             | maximum photos retained in one durable capture session before the UI continues in a new background batch                                                                                  |
| HBOX_AI_MAX_ITEMS                       | 25                                                                                             | maximum item suggestions accepted from one model response                                                                                                                                  |
| HBOX_AI_GEMINI_ENABLED                  | false                                                                                          | enable Gemini as an optional reanalysis provider; initial capture still uses the primary provider                                                                                          |
| HBOX_AI_GEMINI_NAME                     | Gemini                                                                                         | display name for the Gemini reanalysis option                                                                                                                                               |
| HBOX_AI_GEMINI_BASE_URL                 | https://generativelanguage.googleapis.com/v1beta/openai                                        | Gemini OpenAI-compatible API base URL                                                                                                                                                        |
| HBOX_AI_GEMINI_API_KEY                  |                                                                                                | Gemini API key; kept server-side and redacted from configuration output                                                                                                                     |
| HBOX_AI_GEMINI_MODEL                    | gemini-3.6-flash                                                                               | Gemini vision model used only when explicitly selected during review                                                                                                                        |
